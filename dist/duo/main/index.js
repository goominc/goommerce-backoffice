...
var mainModule = angular.module('backoffice.main', ['ui.router', 'ngCookies', require('../directives/module.js').name, require('../dashboard/module').name, require('../user/module').name, require('../product/module').name, require('../order/module').name, require('../third_party/angular-translate')]).config(function ($translateProvider) {
...
}, {"../directives/module.js":3,"../dashboard/module":4,"../user/module":5,"../product/module":6,"../order/module":7,"../third_party/angular-translate":8,"./i18n/translations.en.json":9,"./i18n/translations.ko.json":10}],
...
}, {"../third_party/angular-translate":8,"./i18n/translations.en.json":12,"./i18n/translations.ko.json":13,"./controllers.js":14}],
8: [function(require, module, exports) {
'use strict';

module.exports = require('angular-translate/bower-angular-translate@2.7.2:angular-translate.min.js');
}, {"angular-translate/bower-angular-translate@2.7.2:angular-translate.min.js":15}],
...
require('./controllers.js');
// END module require js
}, {"../third_party/angular-translate":8,"./i18n/translations.en.json":16,"./i18n/translations.ko.json":17,"./controllers.js":18}],
...
require('./controllers.js');
// END module require js
}, {"../third_party/angular-translate":8,"./i18n/translations.en.json":19,"./i18n/translations.ko.json":20,"./controllers.js":21}],
...
require('./controllers.js');
// END module require js
}, {"../third_party/angular-translate":8,"./i18n/translations.en.json":22,"./i18n/translations.ko.json":23,"./controllers.js":24}],
