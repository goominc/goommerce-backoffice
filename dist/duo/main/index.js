...
couponModule.controller('CouponEditController', function ($scope, $http, $state, $rootScope, $translate, boUtils) {
  ...
  $scope.fields = [{ name: '쿠폰명', key: 'name' }, { name: '시작날짜', key: 'begin', placeholder: 'YYYY-MM-DD' }, { name: '종료날짜', key: 'end', placeholder: 'YYYY-MM-DD' }, { name: '할인 타입', key: 'type', enums: [{ title: '가격', value: 1 }, { title: '비율(%)', value: 2 }, { title: '상품증정', value: 3 }] }, { name: '할인 값', key: 'value' }, { name: '최소금액', key: 'minValue' }];
...
productModule.controller('ProductEditController', function ($scope, $http, $state, $rootScope, $translate, product, categories, productUtil, boUtils) {
  $scope.allColors = {
    BLUE: ['RBL', 'BLU', 'VBL', 'NVY', 'MNT', 'CBL', 'DNV', 'CBT', 'LBL', 'DBR', 'DBL', 'TBL', 'PUR', 'MBL', 'PBL'],
    GREEN: ['GRN', 'AGN', 'KHA', 'BGN', 'DGN', 'LIM', 'LMT'],
    RED: ['RED', 'PNK', 'WNE', 'LOG', 'ORG', 'POR', 'BGD', 'DRD', 'LRD', 'BNR', 'HPK', 'COR'],
