...
var mainModule = angular.module('backoffice.main', ['ui.router', 'ngCookies', require('../directives/module.js').name, require('../dashboard/module').name, require('../user/module').name, require('../product/module').name, require('../order/module').name, require('../brand/module').name, require('../currency/module').name, require('../cms/module').name, require('../third_party/angular-translate')]).config(function ($translateProvider) {
...
}, {"../directives/module.js":3,"../dashboard/module":4,"../user/module":5,"../product/module":6,"../order/module":7,"../brand/module":8,"../currency/module":9,"../cms/module":10,"../third_party/angular-translate":11,"./i18n/translations.en.json":12,"./i18n/translations.ko.json":13}],
...
}, {"../third_party/angular-translate":11,"./i18n/translations.en.json":15,"./i18n/translations.ko.json":16,"./controllers.js":17}],
11: [function(require, module, exports) {
'use strict';

module.exports = require('angular-translate/bower-angular-translate@2.7.2:angular-translate.min.js');
}, {"angular-translate/bower-angular-translate@2.7.2:angular-translate.min.js":18}],
...
require('./controllers.js');
// END module require js
}, {"../third_party/angular-translate":11,"./i18n/translations.en.json":19,"./i18n/translations.ko.json":20,"./controllers.js":21}],
...
// END module require js
}, {"../third_party/angular-translate":11,"./i18n/translations.en.json":22,"./i18n/translations.ko.json":23,"./controllers/ProductMainController":24,"./controllers/ProductEditController":25,"./controllers/CategoryEditController":26,"./controllers/ProductBatchUploadController":27,"./controllers/ProductImageUploadController":28}],
...
require('./controllers.js');
// END module require js
}, {"../third_party/angular-translate":11,"./i18n/translations.en.json":29,"./i18n/translations.ko.json":30,"./controllers.js":31}],
...
require('./controllers.js');
// END module require js
}, {"../utils/module":14,"../third_party/angular-translate":11,"./i18n/translations.en.json":32,"./i18n/translations.ko.json":33,"./controllers.js":34}],
...
require('./controllers.js');
// END module require js
}, {"../third_party/angular-translate":11,"./i18n/translations.en.json":35,"./i18n/translations.ko.json":36,"./controllers.js":37}],
...
require('./controllers');
// END module require js
}, {"../third_party/angular-translate":11,"./i18n/translations.en.json":38,"./i18n/translations.ko.json":39,"./controllers":40}],
