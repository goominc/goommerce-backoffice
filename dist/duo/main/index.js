...
orderModule.controller('OrderMainController', function ($scope, $rootScope, $http, $state, $translate, $compile, boUtils, orderCommons) {
  ...
  $scope.orderDatatables = {
    ...
    columns: [{
      ...
      data: function data(_data5) {
        return _.get(_data5, 'data.affiliate.source') || '';
      }
    }]
  };
    ...
    function run() {
      ...
      var rowData = function rowData() {
        return [{
          ...
          values: [{ userEnteredValue: { stringValue: 'NO' } }, { userEnteredValue: { stringValue: '브랜드' } }, { userEnteredValue: { stringValue: '상품번호' } }, { userEnteredValue: { stringValue: '상품명' } }, { userEnteredValue: { stringValue: '컬러' } }, { userEnteredValue: { stringValue: '사이즈' } }, { userEnteredValue: { stringValue: '주문수량' } }, { userEnteredValue: { stringValue: '최종수량' } }, { userEnteredValue: { stringValue: '금액' } }]
        }].concat(_toConsumableArray(order.orderProducts.map(function (op, index) {
          return {
            values: [{ userEnteredValue: { stringValue: (index + 1).toString() } }, { userEnteredValue: { stringValue: op.brand.name.ko } }, { userEnteredValue: { stringValue: op.product.id.toString() } }, { userEnteredValue: { stringValue: op.product.name.ko } }, { userEnteredValue: { stringValue: op.productVariant.data.color } }, { userEnteredValue: { stringValue: op.productVariant.data.size } }, { userEnteredValue: { stringValue: op.quantity.toString() } }, { userEnteredValue: { stringValue: _.get(op, 'finalQuantity', '').toString() } }, { userEnteredValue: { stringValue: _.get(op, 'finalTotalKRW', '').toString() } }]
          };
        })), [{
          // blank line
        }, {
          ...
          values: [{ userEnteredValue: { stringValue: '상품가격' } }, { userEnteredValue: { stringValue: _.get(order, 'subtotalKRW', '').toString() } }, { userEnteredValue: { stringValue: _.get(order, 'finalSubtotalKRW', '').toString() } }]
        }, {
          values: [{ userEnteredValue: { stringValue: '세금' } }, { userEnteredValue: { stringValue: _.get(order, 'taxKRW', '').toString() } }, { userEnteredValue: { stringValue: _.get(order, 'finalTaxKRW', '').toString() } }]
        }, {
          values: [{ userEnteredValue: { stringValue: '사입비' } }, { userEnteredValue: { stringValue: _.get(order, 'handlingFeeKRW', '').toString() } }, { userEnteredValue: { stringValue: _.get(order, 'finalHandlingFeeKRW', '').toString() } }]
        }, {
          values: [{ userEnteredValue: { stringValue: '운송비' } }, { userEnteredValue: { stringValue: _.get(order, 'shippingCostKRW', '').toString() } }, { userEnteredValue: { stringValue: _.get(order, 'finalShippingCostKRW', '').toString() } }]
        }, {
          values: [{ userEnteredValue: { stringValue: '가격조정' } }, { userEnteredValue: { stringValue: _.get(order, 'adjustmentTotalKRW', '').toString() } }, { userEnteredValue: { stringValue: _.get(order, 'finalAdjustmentTotalKRW', '').toString() } }]
        }, {
          values: [{ userEnteredValue: { stringValue: '전체금액' } }, { userEnteredValue: { stringValue: _.get(order, 'totalKRW', '').toString() } }, { userEnteredValue: { stringValue: _.get(order, 'finalTotalKRW', '').toString() } }]
        }, {
          // blank line
        }, {
...
orderModule.controller('OrderUncleController', function ($scope, $rootScope, $http, $state, $translate) {
  ...
  $scope.orderDatatables = {
    ...
    columns: [{
      data: function data(_data9) {
        return _.get(_data9, 'processedDate', '').substring(2, 10);
      },
      bSortable: false
    }, {
      data: 'orderId',
      ...
      data: function data(_data10) {
        return _.get(_data10, 'brand.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data11) {
        return _.get(_data11, 'brand.data.location.building.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data12) {
        return _.get(_data12, 'brand.data.location.floor', '');
      },
      bSortable: false
    }, {
      data: function data(_data13) {
        return _.get(_data13, 'brand.data.location.flatNumber', '');
      },
      bSortable: false
    }, {
      data: function data(_data14) {
        return _.get(_data14, 'brand.data.tel', '');
      },
      bSortable: false
    }, {
      data: function data(_data15) {
        return _.get(_data15, 'product.id', '');
      },
      bSortable: false
    }, {
      data: function data(_data16) {
        return _.get(_data16, 'product.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data17) {
        return _.get(_data17, 'productVariant.data.color', '');
      },
      bSortable: false
    }, {
      data: function data(_data18) {
        return _.get(_data18, 'productVariant.data.size', '');
      },
      bSortable: false
    }, {
      data: 'quantity',
  ...
  $scope.orderDatatables = {
    ...
    columns: [{
      ...
      data: function data(_data19) {
        return _.get(_data19, 'brand.id', '');
      },
      bSortable: false
    }, {
      data: function data(_data20) {
        return _.get(_data20, 'brand.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data21) {
        return _.get(_data21, 'brand.data.tel', '');
      },
      bSortable: false
    }, {
      data: function data(_data22) {
        return _.get(_data22, 'brand.data.bank.name', '');
      },
      bSortable: false
    }, {
      data: function data(_data23) {
        return _.get(_data23, 'brand.data.bank.accountHolder', '');
      },
      bSortable: false
    }, {
      data: function data(_data24) {
        return _.get(_data24, 'brand.data.bank.accountNumber', '');
      },
      bSortable: false
    }, {
      data: function data(_data25) {
        return _.get(_data25, 'product.id', '');
      },
      bSortable: false
    }, {
      data: function data(_data26) {
        return _.get(_data26, 'product.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data27) {
        return _.get(_data27, 'productVariant.data.color', '');
      },
      bSortable: false
    }, {
      data: function data(_data28) {
        return _.get(_data28, 'productVariant.data.size', '');
      },
      bSortable: false
    }, {
      data: 'quantity',
      ...
      data: function data(_data29) {
        return (+_data29.totalKRW).format();
      },
      bSortable: false
    }, {
      data: function data(_data30) {
        return _.get(_data30, 'processedDate', '').substr(0, 10);
      },
      bSortable: false
    }, {
      data: 'buyerId',
  ...
  $scope.orderDatatables = {
    ...
    columns: [{
      ...
      data: function data(_data32) {
        return _.get(_data32, 'name') || '';
      }
    }, {
      data: function data(_data33) {
        return _.get(_data33, 'data.tel') || '';
      }
    }, {
      data: 'email'
    }]
