...
orderModule.controller('OrderMainController', function ($scope, $rootScope, $http, $state, $translate, boUtils) {
  ...
  $scope.orderDatatables = {
    ...
    columns: [{
      ...
      data: function data(_data4) {
        return _.get(_data4, 'data.affiliate.source') || '';
      }
    }]
  };
...
orderModule.controller('OrderUncleController', function ($scope, $rootScope, $http, $state, $translate) {
  ...
  $scope.orderDatatables = {
    ...
    columns: [{
      data: function data(_data8) {
        return _.get(_data8, 'processedDate', '').substring(2, 10);
      },
      bSortable: false
    }, {
      data: 'orderId',
      ...
      data: function data(_data9) {
        return _.get(_data9, 'brand.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data10) {
        return _.get(_data10, 'brand.data.location.building.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data11) {
        return _.get(_data11, 'brand.data.location.floor', '');
      },
      bSortable: false
    }, {
      data: function data(_data12) {
        return _.get(_data12, 'brand.data.location.flatNumber', '');
      },
      bSortable: false
    }, {
      data: function data(_data13) {
        return _.get(_data13, 'brand.data.tel', '');
      },
      bSortable: false
    }, {
      data: function data(_data14) {
        return _.get(_data14, 'product.id', '');
      },
      bSortable: false
    }, {
      data: function data(_data15) {
        return _.get(_data15, 'product.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data16) {
        return _.get(_data16, 'productVariant.data.color', '');
      },
      bSortable: false
    }, {
      data: function data(_data17) {
        return _.get(_data17, 'productVariant.data.size', '');
      },
      bSortable: false
    }, {
      data: 'quantity',
  ...
  $scope.orderDatatables = {
    ...
    columns: [{
      ...
      data: function data(_data18) {
        return _.get(_data18, 'brand.id', '');
      },
      bSortable: false
    }, {
      data: function data(_data19) {
        return _.get(_data19, 'brand.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data20) {
        return _.get(_data20, 'brand.data.tel', '');
      },
      bSortable: false
    }, {
      data: function data(_data21) {
        return _.get(_data21, 'brand.data.bank.name', '');
      },
      bSortable: false
    }, {
      data: function data(_data22) {
        return _.get(_data22, 'brand.data.bank.accountHolder', '');
      },
      bSortable: false
    }, {
      data: function data(_data23) {
        return _.get(_data23, 'brand.data.bank.accountNumber', '');
      },
      bSortable: false
    }, {
      data: function data(_data24) {
        return _.get(_data24, 'product.id', '');
      },
      bSortable: false
    }, {
      data: function data(_data25) {
        return _.get(_data25, 'product.name.ko', '');
      },
      bSortable: false
    }, {
      data: function data(_data26) {
        return _.get(_data26, 'productVariant.data.color', '');
      },
      bSortable: false
    }, {
      data: function data(_data27) {
        return _.get(_data27, 'productVariant.data.size', '');
      },
      bSortable: false
    }, {
      data: 'quantity',
      ...
      data: function data(_data28) {
        return (+_data28.totalKRW).format();
      },
      bSortable: false
    }, {
      data: function data(_data29) {
        return _.get(_data29, 'processedDate', '').substr(0, 10);
      },
      bSortable: false
    }, {
      data: 'buyerId',
  ...
  $scope.orderDatatables = {
    ...
    columns: [{
      ...
      data: function data(_data31) {
        return _.get(_data31, 'name') || '';
      }
    }, {
      data: function data(_data32) {
        return _.get(_data32, 'data.tel') || '';
      }
    }, {
      data: 'email'
    }]
    ...
    $scope.orderDatatables = {
      ...
      columns: [{
        ...
        data: function data(_data34) {
          return _.get(_data34, 'brand.name.ko', '');
        }
      }, {
        data: function data(_data35) {
          return _.get(_data35, 'brand.data.tel', '');
        }
      }, {
        data: function data(_data36) {
          return _.get(_data36, 'brand.data.bank.name', '');
        }
      }, {
        data: function data(_data37) {
          return _.get(_data37, 'brand.data.bank.accountNumber', '');
        }
      }, {
...
userModule.controller('UserInfoController', function ($scope, $http, $state, $rootScope, $translate, user, boUtils, userUtil, convertUtil) {
  ...
  var init = function init(user) {
    ...
    $scope.userFields = [{ title: 'ID', key: 'id', obj: $scope.user.id, isReadOnly: true, isRequired: true }, { title: $translate.instant('user.info.emailLabel'), obj: $scope.user.email, key: 'email', isReadOnly: true, isRequired: true }, { title: $translate.instant('user.info.lastNameLabel'), obj: _.get($scope.user, 'data.lastName'), isReadOnly: true, isRequired: true }, { title: $translate.instant('user.info.firstNameLabel'), obj: _.get($scope.user, 'data.firstName'), isReadOnly: true, isRequired: true }, { title: $translate.instant('user.info.userTypeLabel'), obj: userUtil.getRoleName($scope.user), isReadOnly: true, isRequired: false }, { title: $translate.instant('user.info.telLabel'), obj: _.get($scope.user, 'data.tel'), key: 'data.tel', isRequired: false }, { title: $translate.instant('user.info.gradeLabel'), obj: _.get($scope.user, 'data.grade'), key: 'data.grade', isRequired: false }, { title: $translate.instant('user.info.bizNameLabel'), obj: _.get($scope.user, 'data.bizName'), key: 'data.grade', isRequired: false }, { title: $translate.instant('user.info.bizNumberLabel'), obj: _.get($scope.user, 'data.bizNumber'), key: 'data.grade', isRequired: false }, { title: $translate.instant('user.info.vbankCodeLabel'), obj: _.get($scope.user, 'inipay.vbank.bank'), key: 'inipay.vbank.bank', isRequired: false }, { title: $translate.instant('user.info.vbankAccountLabel'), obj: _.get($scope.user, 'inipay.vbank.vacct'), key: 'inipay.vbank.vacct', isRequired: false }, { title: $translate.instant('user.info.settlementAliasLabel'), obj: _.get($scope.user, 'data.settlement.alias'), key: 'data.settlement.alias', isRequired: false }, { title: $translate.instant('user.info.orderPrefixLabel'), obj: _.get($scope.user, 'data.order.prefix'), key: 'data.order.prefix', isRequired: false }];
