...
var mainModule = angular.module('backoffice.main', ['ui.router', 'ngCookies', require('../dashboard/module').name, require('../user/module').name, require('../product/module').name, require('../third_party/angular-translate')]).config(function ($translateProvider) {
...
}, {"../dashboard/module":2,"../user/module":3,"../product/module":4,"../third_party/angular-translate":5,"./i18n/translations.en.json":6,"./i18n/translations.ko.json":7}],
...
}, {"../third_party/angular-translate":5,"./i18n/translations.en.json":8,"./i18n/translations.ko.json":9,"./controllers.js":10}],
5: [function(require, module, exports) {
'use strict';

module.exports = require('angular-translate/bower-angular-translate@2.7.2:angular-translate.min.js');
}, {"angular-translate/bower-angular-translate@2.7.2:angular-translate.min.js":11}],
...
require('./controllers.js');
// END module require js
}, {"../third_party/angular-translate":5,"./i18n/translations.en.json":12,"./i18n/translations.ko.json":13,"./controllers.js":14}],
...
require('./controllers.js');
// END module require js
}, {"../third_party/angular-translate":5,"./i18n/translations.en.json":15,"./i18n/translations.ko.json":16,"./controllers.js":17}],
...
productModule.controller('ProductMainController', function ($scope, $state, $rootScope, $translate) {
